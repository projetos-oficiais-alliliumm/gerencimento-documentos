...
const Home = () => {
  ...
  const [optionTipoDoc, setOptionTipoDoc] = useState<optionTipoDocType>([]);
  ...
  const validateForm = () => {
    const newErrors: newErrorsType = {
      ...
      dataDocumento: !dataDocumento ? "Data do documento é obrigatória" : "",
      tipo: !tipo ? "Tipo é obrigatório" : "",
      numeroDocumento: !numeroDocumento
        ? "Número do documento é obrigatório"
        : "",
      titulo: !titulo ? "Título é obrigatório" : "",
    };
    setErrors(newErrors);
  ...
  return (
    <>
      <AreaMain>
        <Container wd="7">
          <Title1>Gerenciamento de Documentos</Title1>
          <div>
          ...
          <div style={styledContainerDiv}>
            <div style={styledEntreDiv}>
              ...
              <Input
                type="text"
                value={filterNbDoc}
                onChange={(e) => setFilterNbDoc(e.target.value)}
              />
            </div>
            <div style={styledEntreDiv}>
              <Label>Título</Label>
